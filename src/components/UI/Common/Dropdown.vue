<template>
  <Menu as="div" class="relative inline-block text-left">
    <div class="transition-colors">
      <MenuButton class="inline-flex w-full justify-center bg-white px-4 py-2 text-sm font-small text-def shadow-sm hover:bg-gray-50 focus:outline-none hover:text-def/50">
    ...
    <transition enter-active-class="transition ease-out duration-100" enter-from-class="transform opacity-0 scale-95" enter-to-class="transform opacity-100 scale-100" leave-active-class="transition ease-in duration-75" leave-from-class="transform opacity-100 scale-100" leave-to-class="transform opacity-0 scale-95">
      <MenuItems class="absolute bottom-10 left-2 z-10 mt-2 w-44 origin-top-right rounded-md bg-white drop-shadow-lg focus:outline-none rounded-md">
        <div class="py-2">
