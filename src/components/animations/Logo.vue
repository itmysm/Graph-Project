<template>
  <div class="content w-full h-full bg-transparent flex flex-col items-center justify-center">
    <svg class="w-20 h-20">
      <g id="loader-3">
        <rect id="bg" fill="none" x="0" y="0" width="10" height="10"></rect>
        <g
          class="linechart-loader"
          transform="translate(13.000000, 25.000000)"
          stroke="#CBCDD2"
          stroke-width="2"
        >
          <polyline
...
.linechart-loader {
  .linechart {
    ...
    stroke-dashoffset: -150;
    animation: dash 3s linear both normal;
