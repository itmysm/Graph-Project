...
export default function UploadBox({ i18n, showDialog, onCloseDialog }: Props) {
        ...
        <ModalContent className="lg:min-w-[700px] border border-gray/20 bg-gradient-secondary">
          {(onClose) => (
            <>
              ...
              <ModalFooter>
                <Button
                  className="text-contrast font-semibold bg-secondary hover:bg-secondary/90 rounded-lg"
                  onPress={onClose}
                >
                  Close
                </Button>
