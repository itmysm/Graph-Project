...
export default function Home() {
  ...
  const features = [
    {
      ...
      description:
        "Graph is an open-source project with its source code available on GitHub, ensuring high security as it operates entirely client-side, with no data being sent to the server.",
      icon: (
        <FiKey style={{ color: "rgb(var(--color-yellow))", size: "50px" }} />
      ),
    },
    {
      title: "Responsive For Mobile",
      description:
        "The website is designed to be highly responsive, ensuring a seamless user experience across various browsers and devices, prioritizing optimal functionality and user satisfaction.",
      icon: (
        <FiGrid style={{ color: "rgb(var(--color-teal))", size: "50px" }} />
      ),
    },
    {
      title: "Customizable",
      description:
        "Graph provides extensive customization options, empowering users to personalize their experience by adjusting the program's language, theme, and more to suit their preferences and needs.",
      icon: <FiPenTool style={{ color: "#eb92d5", size: "50px" }} />,
    },
    {
      title: "No Need To internet",
      description:
        "Graph also offers a PWA that allows you to access it offline, ensuring convenient availability and enhanced security measures.",
      icon: (
        <FiWifiOff style={{ color: "rgb(var(--color-info))", size: "50px" }} />
      ),
    },
  ];
  ...
  const faq = [
    {
      title: "Which apps does Graph support?",
      description:
        "It has been tried as much as possible to support the exported data of all famous social media in the world. But currently Graph supports Telegram, WhatsApp and Instagram",
    },
    {
      title: "Are my uploaded chats on the graph stored on your servers?",
      description:
        "No! As mentioned above, all calculations and analyzes are performed on your device and no data is sent from users to the server.",
    },
    {
      title: "Can I contribute to this project?",
      description:
        "Yes! We welcome any kind of cooperation on this project and we welcome your cooperation.",
    },
  ];
  ...
  const socialMedia = [
    {
      title: "Github",
      icon: (
        <FiGithub style={{ color: "rgb(var(--color-teal))", size: "50px" }} />
      ),
      link: "https://www.github.com/itmysm",
    },
    {
      title: "Twitter",
      icon: (
        <FiTwitter style={{ color: "rgb(var(--color-teal))", size: "50px" }} />
      ),
      link: "https://www.twitter.com/itmysm",
    },
    {
      title: "Codepen",
      icon: (
        <FiCodepen style={{ color: "rgb(var(--color-teal))", size: "50px" }} />
      ),
      link: "https://www.codepen.com/itmysm",
    },
    {
      title: "Telegram",
      icon: (
        <FiSend style={{ color: "rgb(var(--color-teal))", size: "50px" }} />
      ),
      link: "https://www.t.me/itmysm",
    },
  ];
    ...
    >
      <div className="w-full xl:max-w-[1200px]">
        ...
        >
          ...
          <p className="text-base md:text-md text-center mt-5 text-primary-hover tracking-wider">
            Customize to fit your brand and impress your customers with a
          ...
          <p className="text-teal font-semibold text-sm tracking-widest mt-6">
        ...
        <section className="flex flex-col items-center px-12 md:px-0 overflow-hidden">
          <div className="flex flex-col items-center mt-24 md:mt-48">
            <div className="w-full flex flex-col items-center">
              <p className="text-xs text-teal uppercase text-center font-semibold tracking-widest">
                FEATURES
              </p>
              <p className="md:w-4/6 lg:w-3/6 xl:w-4/6 text-3xl lg:text-4xl font-black text-center text-primary mt-6 leading-[1.5]">
                What makes Graph so special?
              </p>
              <p className="text-primary text-sm mt-5 text-center">
                There are plenty of benefits when using *** template. We tried
                to list some of them out.
              </p>
            </div>
            ...
            <ul className="w-full grid grid-col-1 md:grid-cols-2 lg:grid-cols-4 gap-y-16 md:gap-y-8 gap-x-2 md:gap-x-6 lg:gap- mt-32">
              {features.map((item, index) => (
                <li className="flex flex-col items-center" key={index}>
                  ...
                  <p className="mt-4 text-primary md:text-lg font-semibold">
                    {item.title}
                  </p>
                  <p className="text-sm text-gray-text font-normal tracking-wider text-center mt-3">
                    {item.description}
                  </p>
                </li>
              ))}
          ...
          <div className="h-[450px] flex flex-col w-[400px] md:w-full md:grid grid-cols-12 md:gap-x-10 lg:gap-x-20 justify-center mt-20 md:mt-36 lg:mt-48">
            ...
            <div className="lg:flex flex-col justify-center col-span-12 md:col-span-6 text-center md:text-left mt-8 md:mt-0 xl:px-10">
              <h3 className="text-primary text-xl md:text-2xl lg:text-3xl xl:text-4xl font-semibold">
                Animations & effects
              </h3>
              <p className="text-sm md:text-base text-gray-text font-normal tracking-wider mt-4 xl:mt-8">
                Pre-built animations and effects such as scroll transforms,
                appear animation, component interactions and more. Benefits? A
                more dynamic and engaging website that encourages users to
        ...
        <section className="mt-20 md:mt-32 lg:mt-48">
          <div className="flex flex-col items-center tetx-center">
            ...
            <h3 className="text-primary text-5xl font-semibold mt-8">
              Got questions?
            </h3>
            <div className="flex flex-col text-center text-sm md:text-base text-primary-active mt-6">
              ...
              <a
                className="text-primary hover:text-info transition mt-1"
        ...
        <footer className="flex flex-col justify-center items-center mt-20 md:mt-32 lg:mt-40 transition-all">
          <h2 className="text-xl text-info font-semibold tracking-widest">
            Graph Project
          </h2>
          <div className="flex justify-center mt-8">
            <a
              className="text-primary hover:text-info font-semibold mr-5"
              href="#"
            >
              Privacy Policy
            </a>
            <a
              className="text-primary hover:text-info font-semibold ml-5"
              href="#"
            >
              Terms of Service
            </a>
